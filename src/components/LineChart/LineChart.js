        ...
        <div className='chartContainer'>
            <div className='chartContainerHeader'>
                ...
                <button className="admissionButton">
                    Admission Rate
                    <svg id="admissionRateIcon" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-down" width="26" height="26" viewBox="0 0 24 24" stroke-width="1.5" stroke="#597e8d" fill="none" stroke-linecap="round" stroke-linejoin="round">
